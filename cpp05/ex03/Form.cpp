...
Form::Form() : _name("Unknow"), _signed(false), _gradeexec(150), _gradesign(150){
	return ;
}

Form::Form(const std::string name, const int gradeexe, const int gradesign) : _name(name), _signed(false){
